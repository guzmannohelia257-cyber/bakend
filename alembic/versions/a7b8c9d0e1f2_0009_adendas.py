...
Modelo Adenda: ampliacion de presupuesto registrada por el tecnico cuando
descubre danos ocultos. Asignacion se congela en 'en_espera_aprobacion'
hasta que el cliente apruebe o rechace.
"""
...
def upgrade() -> None:
    ...
    # Asegurar que el catalogo tenga 'en_espera_aprobacion'.
    op.execute(
